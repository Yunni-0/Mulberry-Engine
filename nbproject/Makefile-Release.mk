...
${OBJECTDIR}/glad.o: glad.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glad.o glad.c

${OBJECTDIR}/glm/detail/glm.o: glm/detail/glm.cpp
	${MKDIR} -p ${OBJECTDIR}/glm/detail
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glm/detail/glm.o glm/detail/glm.cpp

${OBJECTDIR}/include/stbInit.o: include/stbInit.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/stbInit.o include/stbInit.cpp
